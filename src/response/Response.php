...
class Response {
    ...
    const RESPONSE_CODES = [
        'bg' => [
            ...
            '-22' => 'Транзакцията съдържа невалидни данни за автентикация',
            ...
            '-33' => 'Транзакцията е в процес на автентикация на картодържателя',
     ...
     *
     * TODO: Rename the property `terminalId`
     *
     * @var string
     */
    public $terminal;
     ...
     * Описание: Действие
     * Размер: 1-2
     * Съдържание: E-Gateway код на действие:
     * 0 – успешно приключена транзакция
     * 1 – дублирана транзакция
     * 2 – отказана транзакция
     * 3 – грешка при обработка на транзакцията
     * 7 – дублирна транзакция при неуспешна автентикация
     * 21 – Soft Decline
     *
     * @var integer
     */
     ...
     * Размер: 2
     * Съдържание: Отговор при обработка на транзакция от APGW или издателя на картата по ISO- 8583, поле 39
     *
     * @var string
     */
    public $responseCode;
    ...
    /**
     * Описание: Одобрение (авторизационен код)
     * Размер: 6
    ...
    /**
     * Описание: Маскиран номер на картата
     * Размер: 16-19
     * Съдържание: Маскиран номер на картата (н.р. "5100XXXXXXXX0022")
     *
     * @var string
     */
    public $cardNumber;
     ...
     * Описание: Дата/час
     * Размер: 19
     * Съдържание: Дата/час на транзакцията по GMT (UTC) във формат "YYYYMMDDHHMMSS"
     *
     * @var string
     */
